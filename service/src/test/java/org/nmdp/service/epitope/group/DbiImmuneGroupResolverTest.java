...
public class DbiImmuneGroupResolverTest {
	@Mock
	...
	@InjectMocks
	private DbiImmuneGroupResolver resolver;

	@Test
	public void testApply() throws Exception {
		Allele a1 = EpitopeServiceTestData.group1Alleles().get(0);
		Allele a2 = EpitopeServiceTestData.group1Alleles().get(1);
		when(dbiManager.getAllelesForImmuneGroup(1)).thenReturn(Arrays.asList(a1.getGlstring(), a2.getGlstring()));
